...
Este projeto foi desenvolvido como desafio técnico para a Nexdom.
...
**Desenvolvido com ❤️ usando Spring Boot, Vue.js 3 e Tailwind CSS**
...
- ✅ Frontend Vue.js 3 responsivo
- ✅ Integração Backend ↔ Frontend
- ✅ Dockerização completa
- ✅ Documentação Swagger
- ✅ Validações de negócio
- ✅ Relatórios e análises
- ⚠️ Testes unitários (em desenvolvimento)
- ⚠️ Autenticação/Autorização (não implementado)
- ⚠️ Paginação (não implementado)

Para roadmap completo e limitações conhecidas, consulte a [Documentação Arquitetural](docs/README.MD).
